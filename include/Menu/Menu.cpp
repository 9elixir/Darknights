...
Menu::Menu(QWidget *parent, QtHello *father, QSize size) {
  ...
  QPixmap characpix =
      QPixmap("imgs\\Chongyue\\ChongYue.png").scaled(this->leftLabel->size());
  ...
  str[0] = "";
  str[0] = std::to_string(father->getman()->getHp()) + "/" +
           std::to_string(father->getman()->getHpMax());

  str[1] = "";
  str[1] = std::to_string(father->getman()->getMp()) + "/" +
           std::to_string(father->getman()->getMpMax());
  ...
  str[4] = "";
  str[4] = std::to_string(father->getman()->getNowExp()) + "/" +
           std::to_string(father->getman()->getLevelup_Exp());
  ...
  this->rightLabel5->move(this->width() / 2 + 25,
                          (this->height() / 8 + 20) * 0 + 20);
  ...
  this->rightLabel0->move(this->width() / 2 + 25,
                          (this->height() / 8 + 20) * 1 + 20);
  ...
  this->rightLabel1->move(this->width() / 2 + 25,
                          (this->height() / 8 + 20) * 2 + 20);
  ...
  this->rightLabel2->move(this->width() / 2 + 25,
                          (this->height() / 8 + 20) * 3 + 20);
  ...
  this->rightLabel3->move(this->width() / 2 + 25,
                          (this->height() / 8 + 20) * 4 + 20);
  ...
  this->rightLabel4->move(this->width() / 2 + 25,
                          (this->height() / 8 + 20) * 5 + 20);
